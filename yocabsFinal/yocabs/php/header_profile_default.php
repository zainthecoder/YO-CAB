  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
       ...
       <li class="nav-item ">
        <a class="nav-link" href="#booking"><i class="fas fa-car"></i><strong> BOOK CAB <span class="sr-only">(current)</span></strong></a>
      </li>
    ...
    <a href="home1.php"><button class="btn float-right btn-primary">login</button></a>

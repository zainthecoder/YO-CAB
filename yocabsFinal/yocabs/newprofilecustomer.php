...
<div class="row"  >
  <div class="col-md-5 ">
     ...
     <img src="<?php echo $my_image;?>" style="width: 100%; height:600px;" >
     ...
     <div class="img_centered">
       ...
       <?php
          ...
          if($bookingid==5400 ){
            ...
            ?>
             <a href="php/money_reciever.php"><button class="btn btn-warning">Earn Money (if you current Balance is <500)</button></a>
             <?php
          }
          ?>
       ...
       <div class="container">
        ...
        <ul style="font-style: sans-serif ;">
         ...
         <?php
          ...
          <li><h4>CVV: <?php echo $use1;?></h4></li><br>
          <li><h4>Card Number: <?php echo $card_number;?></h4></li><br>
